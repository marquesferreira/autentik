<section class="fondue_vin py-5">
	<div class="container-fluid">
		<div class="row d-flex flex-column flex-lg-row">
			<div class="col-lg-9">
				<div id="slider2">
					<div class="MS-controls d-flex mr-auto product__arrows w-100">
			...
			<div class="col-lg-3 products-hero__textbox">
				...
				<h3>Nos fondue & Vin</h3>
				<p class="__descproduct">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus consequat tellus eu accumsan mollis. Phasellus sit amet bibendum velit. Curabitur suscipit efficitur erat. Pellentesque posuere id massa quis gravida. Aenean</p>
				<div class="d-inline-flex align-items-center ">
					<a href="#" class="d-inline-flex align-items-center">
						<p class="">Nos Packs Fondue & Vin</p> 
				...
				<p class="f__montserrat red-text mb-5">Livraison gratuite !</p>
			</div>			
		</div>
	</div>
</section> 
